...
public class ModBlockTags {
    ...
    public static final TagKey<Block> TURRET_ROTATE = create("turret_rotate");
    public static final TagKey<Block> TURRET_STRENGTH = create("turret_strength");
    public static final TagKey<Block> TURRET_MAX_ROTATE = create("turret_max_rotate");
